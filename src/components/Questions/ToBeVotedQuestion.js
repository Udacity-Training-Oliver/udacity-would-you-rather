    ...
    <Card className='m-3' style={{width: '32rem'}}>
      ...
      <Card.Body>
        <Container>
          <Row>
            <Col lg={4}>
              <Card.Img width={113} variant="Top"
              ...
              <div onChange={handleChange}>
                <div className="form-check">
                  <input type="radio" className="form-check-input"
                    id="radioOptionOne" name="optradio" value="optionOne" />
                  <label className="form-check-label" htmlFor="radioOptionOne">
                    {optionOne}
                  </label>
                </div>
                <div className="form-check">
                  <input type="radio" className="form-check-input"
                    id="radioOptionTwo" name="optradio" value="optionTwo" />
                  <label className="form-check-label" htmlFor="radioOptionTwo">
                    {optionTwo}
                  </label>
                </div>
              </div>
...
export default ToBeVotedQuestion;
